...
# cd .. moves you back out of the folder you are in
...
st.title("Welcome to My First Ever Page!")
...
if st.button("Beat me up with your mouse"):
    st.write("OUCH!")
else:
    st.button("Click me if you dare")
